---
name: design-console-smallform
description: Pixel-perfect compact UI guidance for console-style Dartsnut games and widgets.
license: MIT
---
...
For widget `conf.json` types, keep game flavor lightweight:
